...
class CoordinateAttention(nn.Module):
    ...
    Captures long-range dependencies along spatial directions while preserving
    precise positional information. More effective than SE/CBAM for small targets.
...
class EdgeEnhancement(nn.Module):
    ...
    Uses low-frequency suppression and high-frequency enhancement strategy
    to improve edge feature extraction for small targets in thermal images.
